...
const PROFILE_FIELDS = ['fullname','furigana','birthDate','age','postalCode','address','phone','daytimePhone','education','qualifications'];
...
function formatProfileForMessage(profile) {
  ...
  if (profile.daytimePhone) lines.push(`昼間の連絡先: ${profile.daytimePhone}`);
